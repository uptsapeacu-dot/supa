  ...
  bairros.forEach(b => {
    checkboxesBairros += `
      <label style="display:flex; align-items:center; gap:6px; color:#ccc; font-size:13px; cursor:pointer;">
        <input type="checkbox" name="bairrosItinerario" value="${b}" /> ${b}
      </label>
    `;
  });
    ...
    <div id="adminModalCriarRotaBox" style="position:fixed; inset:0; background:rgba(0,0,0,0.8); z-index:9999; display:flex; align-items:center; justify-content:center; padding:20px;">
      <div style="background:#101010; border:1px solid #2a2a2a; border-radius:12px; max-width:500px; width:100%; padding:24px; box-shadow:0 10px 30px rgba(0,0,0,0.5);">
        ...
        <div style="margin-top:15px;">
          ...
          <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:8px; background:rgba(0,0,0,0.2); padding:10px; border-radius:6px; border:1px solid #222;">
            ${checkboxesBairros}
          </div>
        </div>
